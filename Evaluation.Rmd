...
##### Since the 3 top user models feature sets: document_term_matrix, dtm.pca, dtm.lsa.10
```{r Load}
...
document_term_matrix = DocumentTermMatrix(poli.corpus, control = list(Dictionary=Terms(user.corpus))) # 18 rows, 9137 cols
